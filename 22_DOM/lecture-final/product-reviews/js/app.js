...
function displayReviews() {
  ...
  reviews.forEach( (review) => {
      ...
      // add reviewer, rating, title, review
      addReviewer(newDiv, review.reviewer);
      addRating(newDiv, review.rating);
      addTitle(newDiv, review.title);
      addReview(newDiv, review.review);
  });
}
...
function addRating(parent, numberOfStars) {
  ...
  for (let i = 1; i <= numberOfStars; i++) {
    ...
    newImg.classList.add('ratingStar');
    newImg.src = "img/star.png";
    newRating.appendChild(newImg);
  }
